...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-11-2021 a las 14:28:35
...
CREATE TABLE `administrador` (
  ...
  `AdministradorContraseñaEncriptada` varchar(100) NOT NULL,
...
INSERT INTO `administrador` (`AdministradorId`, `AdministradorNombre`, `AdministradorPrimerApellido`, `AdministradorSegundoApellido`, `AdministradorCorreo`, `AdministradorContraseña`, `AdministradorContraseñaEncriptada`, `AdministradorImagen`, `AdministradorPais`, `AdministradorDescripcion`, `AdministradorTelefono`, `AdministradorRol`) VALUES
(3, 'Juan ', 'Diaz', 'Ruiz', 'juan1@gmail.com', '123456', '', 'admin_image2.png', 'México', ' DESCRIPCION', '4491234567', 'Programador'),
(7, 'Viviana', 'Vivero', 'Guzmán', 'viviana123@gmail.com', '123456', '$2y$10$1KcROrDcWFnITI2oPQz9ZezXeWVIC6m/2.DDt8qopjCgrnmiYy2GC', 'monita pelo rojo.jpg', 'México', 'Admin', '4494615205', 'Administrador');
...
CREATE TABLE `bitacora` (
  ...
  `BitacoraProductoId` int(11) NOT NULL,
  `BitacoraNombreProducto` varchar(100) NOT NULL,
  `BitacoraFechaEntrada` date NOT NULL,
  `BitacoraAccionProducto` varchar(50) NOT NULL,
  `BitacoraNombreEmpleado` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `bitacora` (`BitacoraId`, `BitacoraProductoId`, `BitacoraNombreProducto`, `BitacoraFechaEntrada`, `BitacoraAccionProducto`, `BitacoraNombreEmpleado`) VALUES
(1, 67, 'pruebaproducttrigger', '2021-10-22', 'Se insertó el producto', 'Juan '),
(2, 0, '{\"nombre_antes\": \"pruebaproducttrigger\", \"nombre_nuevo\": \"pruebaproducttrigge\"}', '2021-10-22', 'Se actualizó el producto', 'Juan '),
(3, 67, 'pruebaproducttrigge', '2021-10-22', 'Se eliminó el producto', 'Juan ');
...
(23, 'Jazmin', 'Mirales', 'Rodriguez', 'jazz@gmail.com', '987654321', 'México', 'Aguascalientes', '$2y$10$ixk4LDghf8FWvHlfGWNJgO.VWf5vLsmneCg6VdImqPcKs0mZsT3cu', '4498512378', '::1'),
(24, 'Aremi', 'Vázquez', 'Reyes', 'Are@hotmail.com', '122333', 'México', 'Aguascalientes', '$2y$10$/OkQ8bEoXGBm4nZWyfDj4eStPh9aVL2PP3bD8TEt/5rIOa0qWEk.e', '4498512761', '::1'),
(25, 'Miguel Angel', 'Vega', 'Carrillo', 'ElMigue@outlook.com', '445566', 'México', 'Aguascalientes', '$2y$10$Y46Ydfyh6phXa5/aWaRR8e1zFrpbnM8fNcL.mr1Bh1.G3deIBA4F.', '4491769234', '::1'),
(26, 'Luis', 'Hernández', 'García', 'Luisito@hotmail.com', '778899', 'México', 'Aguascalientes', '$2y$10$ic38JUjSEJZX8iq2A3aTl.Z9YT1oOLK7/hgMikvGfDcVr5q9UF1Ha', '4455776216', '::1'),
...
(62, 'Prueba', 'Prueba', 'Prueba', 'Prueba99@gmail.com', '123456789', 'México', 'Aguascalientes', '$2y$10$K.kDqE0sEP19zQs6EuNDFOdqr6iIqWWzfR5PJs9fyDVvQQs4Wa/hK', '4494651232', '127.0.0.1'),
(63, 'prueba', 'prueba', 'preueba', 'prueba100@gmail.com', '123456', 'Mexico', 'Aguascalientes', '$2y$10$ntNkbfHFFJ8y3YTqL8hbY.5SqyRQ5aoVU.oDDhPsV/aurZ4OR/ykm', '4491111108', '127.0.0.1'),
(64, 'usuarioprueba', 'usu', 'usua', 'usuarioprueba@gmail.com', '123456789', 'Mexico', 'Aguascalientes', '$2y$10$blQNlaYZvdxwRskq.euLEec17ZlKdNiCHyAmz3jS0600r.u.1aqii', '4449512315', '::1'),
(65, 'prueba', 'prueba', 'prueba', 'prueba100@gmail.com', '123456', 'México', 'Aguascalientes', '$2y$10$HvLzyFGCU9e8Nk6W4Mhj0eAFIeSz0dscKG68l7ZOcZqpLRZNDf15u', '4494615205', '127.0.0.1'),
(66, 'PruebaCientoDos', 'Prueba', 'prueba', 'prueba102@gmail.com', '123456', 'México', 'Aguascalientes', '$2y$10$RDEgfdKIA8fbaChX3MAWNee7eBm5qdeq42CLK4qiLi.c7G0QmwaTG', '4491686519', '127.0.0.1');
...
(129, 'Esta muy entretenido', 4, 35, 66);
...
(101, 61, 2057887096, 35, 1, 200, '2021-10-03'),
(102, 59, 1013031695, 35, 1, 200, '2021-10-19'),
(103, 59, 1013031695, 59, 1, 186, '2021-10-19'),
(104, 59, 917420786, 51, 1, 60, '2021-10-19'),
(105, 59, 231923637, 54, 1, 900, '2021-10-19'),
(106, 60, 2056839976, 57, 1, 1000, '2021-10-22'),
(107, 60, 1493576716, 49, 1, 1300, '2021-10-22'),
(108, 63, 1279793226, 37, 1, 1100, '2021-10-22'),
(109, 59, 1146979474, 37, 1, 1100, '2021-10-22'),
(110, 64, 353246279, 43, 1, 200, '2021-10-22'),
(111, 64, 1556026030, 36, 1, 190, '2021-10-22'),
(112, 64, 1663735912, 58, 1, 600, '2021-10-24'),
(113, 64, 296302392, 41, 1, 110, '2021-10-24'),
(116, 23, 1880115287, 59, 1, 186, '2021-11-17'),
(117, 66, 1746038527, 35, 1, 200, '2021-11-18');
...
(78, 1556026030, 190, 'Back Code', 2545, '313212313212132231', '$2y$10$mcGMOlLL6L0qL3uaonImLuk6HEcyOH1MOOZK57J34sOFqMd0OJrZu', '2021-10-22'),
(79, 1663735912, 600, 'Back Code', 1231, '554449996633212121', '$2y$10$AhzPRz5RMOZy7P.gryPNiuU/ReRjEl3PmrojRwFtbtwl1xiQENRf.', '2021-10-24'),
(80, 296302392, 110, 'Western Union', 9526, '995558787792515425', '$2y$10$HqCRcwUALUvJda7znTkpt.kaH2KTAMtzwdQ.OW652PB5dwslD/d7W', '2021-10-24'),
(81, 1880115287, 187, 'Back Code', 4949, '258395147532585252', '$2y$10$cc6jd0f3lnaq5MklPiUGOOyh4Iq0mxHO3Q7NIcd9wx1c6f9ENhKrO', '2021-11-17');
...
--
DELIMITER $$
CREATE TRIGGER `trEliminarProd` AFTER DELETE ON `producto` FOR EACH ROW INSERT INTO bitacora(BitacoraProductoId, BitacoraNombreProducto, BitacoraFechaEntrada, BitacoraAccionProducto, BitacoraNombreEmpleado) VALUES (old.ProductoId, old.ProductoTitulo, now(),'Se eliminó el producto', (SELECT administrador.AdministradorNombre FROM administrador WHERE administrador.AdministradorId=3))
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trInsertarProd` AFTER INSERT ON `producto` FOR EACH ROW INSERT INTO bitacora(BitacoraProductoId, BitacoraNombreProducto, BitacoraFechaEntrada, BitacoraAccionProducto, BitacoraNombreEmpleado) VALUES (new.ProductoId, new.ProductoTitulo, now(),'Se insertó el producto', (SELECT administrador.AdministradorNombre FROM administrador WHERE administrador.AdministradorId=3))
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trUpdateProd` AFTER UPDATE ON `producto` FOR EACH ROW INSERT INTO bitacora(BitacoraProductoId, BitacoraNombreProducto, BitacoraFechaEntrada, BitacoraAccionProducto, BitacoraNombreEmpleado) VALUES (JSON_OBJECT('id_antes',old.ProductoId,'id_nueva',new.ProductoId), JSON_OBJECT('nombre_antes',old.ProductoTitulo,'nombre_nuevo',new.ProductoTitulo), now(),'Se actualizó el producto', (SELECT administrador.AdministradorNombre FROM administrador WHERE administrador.AdministradorId=3))
$$
DELIMITER ;
...
--
ALTER TABLE `administrador`
  MODIFY `AdministradorId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `bitacora`
--
ALTER TABLE `bitacora`
  MODIFY `BitacoraId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `cliente`
  MODIFY `ClienteId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;

--
-- AUTO_INCREMENT de la tabla `comentario`
--
ALTER TABLE `comentario`
  MODIFY `ComentarioId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;
...
--
ALTER TABLE `listadeseo`
  MODIFY `ListaDeseoId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT de la tabla `orden`
--
ALTER TABLE `orden`
  MODIFY `OrdenId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;

--
-- AUTO_INCREMENT de la tabla `pago`
--
ALTER TABLE `pago`
  MODIFY `PagoId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;

--
-- AUTO_INCREMENT de la tabla `producto`
--
ALTER TABLE `producto`
  MODIFY `ProductoId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;

--
-- AUTO_INCREMENT de la tabla `visita`
--
ALTER TABLE `visita`
  MODIFY `VisitaId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
