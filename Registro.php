      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          <a class="logo" href="index.php">
            <img src="images/logotipo_gumi.png" alt="image">
          </a>
          <h2 class="text-center">Registrar una nueva cuenta</h2>
          <form class="text-left clearfix" action="Registro.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
            <input type="text" class="form-control" placeholder="Apellido Paterno" name="ClientePaterno" maxlength="40" required pattern="[A-Za-zÀ-ÿ\u00f1\u00d1]+" title="Solo se admiten letras" required>
            </div>
            <div class="form-group">
            <input type="text" class="form-control" placeholder="Apellido Materno" name="ClienteMaterno" maxlength="40" required pattern="[A-Za-zÀ-ÿ\u00f1\u00d1]+" title="Solo se admiten letras" required>
            </div>
            <div class="form-group">
            <input type="email" placeholder="usuario@correo.com" class="form-control" name="ClienteCorreo" required>
            </div>
            <div class="form-group">
            <input type="password" placeholder="Password" class="form-control" name="ClienteContraseña" required>
            </div>
            <div class="form-group">
            <input type="text" class="form-control" placeholder="Pais" name="ClientePais" maxlength="40" required pattern="[A-Za-zÀ-ÿ\u00f1\u00d1 ]+" title="Solo se admiten letras" required>
            </div>
            <div class="form-group">
            <input type="text" class="form-control" placeholder="Ciudad" name="ClienteCiudad" maxlength="40" required pattern="[A-Za-zÀ-ÿ\u00f1\u00d1 ]+" title="Solo se admiten letras" required>
            </div>
            <div class="form-group">
            <input type="number" maxlength="10" size="10" placeholder="4493944545" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" leng class="form-control" name="ClienteTelefono" min="1" required> <i>(Máximo 10 dígitos)</i>
            </div>
            <p class="text-muted">
            ...
            <div class="text-center">
              <button type="submit" class="btn btn-main text-center" name="registrar">Registrar</button>
            </div>
          </form>
