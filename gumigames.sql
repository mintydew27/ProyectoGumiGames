...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-12-2020 a las 04:56:03
...
--
ALTER TABLE `cliente`
  MODIFY `ClienteId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `producto`
  MODIFY `ProductoId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
